...
public class NPC_FarmerNot extends Entity{
    public NPC_FarmerNot(GamePanel gp){
        super(gp);
    ...
    public void getImage() {
        ...
        right2 = setup("/pics/npc/farmer/right00", gp.tileSize, gp.tileSize);
        right3 = setup("/pics/npc/farmer/right00", gp.tileSize, gp.tileSize);
        right4 = setup("/pics/npc/farmer/right00", gp.tileSize, gp.tileSize);
    ...
    public void setDialogue(){
        dialogues[0] = "EXIT NOT ALLOWED";
        dialogues[1] = "EXIT NOT ALLOWED";
